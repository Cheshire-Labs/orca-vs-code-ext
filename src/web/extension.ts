...
import { OrcaTreeDataProvider } from './orca_treeview_provider';
...
export function activate(context: vscode.ExtensionContext) {
	...
	const orcaTreeDataProvider = new OrcaTreeDataProvider();
	context.subscriptions.push(vscode.window.createTreeView('orca-gui.view', { treeDataProvider: orcaTreeDataProvider }));
}
